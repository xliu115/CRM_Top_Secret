...
| 6 | **Draft Card Pattern for All AI Actions** | Competitive landscape (Dreamteam) | S | Low | DEFERRED | Every AI action as a reviewable card before execution. ClientIQ already does this for emails — marginal improvement. |
...
| 9 | **Nudge Effectiveness Analytics + ROI** | Original CEO review (deferred) | M | Low | DEFERRED | Track nudge outcomes (viewed, actioned, email sent). Dashboard chart showing effectiveness by type. New NudgeAction model. Important for proving ClientIQ's value but requires instrumentation across multiple UI flows. |
