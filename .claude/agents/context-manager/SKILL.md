...
description: "Use this agent when multiple agents need shared state, coordinated context retrieval, synchronized task metadata, or structured information access. Invoke this agent for context storage, shared knowledge management, data synchronization, retrieval optimization, and context governance."
